...
// export function LogoCarousel({ data, visibleCount = 5, interval = 3000 }: Readonly<LogoCarouselProps>) {
...
//   // Ambil semua logo dari data
//   const allLogos = data.logoItems;
...
//   // Fungsi untuk mengganti logo secara acak
//   const replaceRandomLogo = () => {
...
//   // Set up interval untuk penggantian logo
//   useEffect(() => {
...
//                 <div 
//                   className="relative p-4 rounded-lg bg-transparent dark:bg-white shadow-none 
...
//                         sizes="128px"
//                         className="transition-opacity duration-300 dark:invert-0"
//                       />
//                     )}
//                   </div>
//                 </div>
